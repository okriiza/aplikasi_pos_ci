...
class kategori extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->template->load('template', 'kategori/kategori_data_view', $data);
    }
    ...
    function post()
    {
        if (isset($_POST['submit'])) {
            ...
            $this->template->load('template', 'kategori/kategori_add_view');
        }
    }
    ...
    function edit()
    {
        if (isset($_POST['submit'])) {
            ...
            $this->template->load('template', 'kategori/kategori_edit_view', $data);
        }
    }
